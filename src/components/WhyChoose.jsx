          ...
          <Col md={4} className="mb-4">
            <Card id="wcu-box" className=" h-100 border-1">
              <Card.Body className="text-center">
                <div className="mb-3" style={{ color: "#25D366" }}>
                ...
                <Card.Text className="text-secondary">
                  ...
                  efficient logistics ensure your concrete is delivered exactly
                  when you need it.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col md={4} className="mb-4">
            <Card id="wcu-box" className="h-100 border-1">
              <Card.Body className="text-center">
                ...
                <Card.Text className="text-secondary">
                  We blend top-grade materials with advanced mixing techniques
                  to deliver concrete that meets the highest industry standards.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={4} className="mb-4">
            <Card id="wcu-box" className="wcu-box h-100 border-1 ">
              <Card.Body className="text-center">
                ...
                <Card.Text className="text-secondary">
                  We offer exceptional value with competitive pricing, proving
                  that quality doesn&apos;t have to come at a premium.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
