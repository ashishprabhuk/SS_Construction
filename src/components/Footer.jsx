      ...
      <Container className="py-5">
        <Row className="g-4 mb-4">
          <Col lg={3} md={6} className="mb-4">
            <div className="iso-certification p-3 rounded d-flex flex-wrap justify-content-center align-items-center">
              <img
                src={oa}
          ...
          <Col lg={3} md={6} className="mb-4">
            ...
            <ul className="list-unstyled">
              <li className="mb-3">
                <i className="bi bi-telephone me-2" style={{ color: "#25D366" }}></i>
              ...
              <li className="mb-3">
                <i className="bi bi-envelope me-2" style={{ color: "#25D366" }}></i>
                <a href="mailto:123@gmail.com" className="text-secondary">123@gmail.com</a>
              </li>
            </ul>
          </Col>
          ...
          <Col lg={3} md={6} className="mb-4">
            ...
            <address className="text-secondary">
              <i className="bi bi-geo-alt-fill me-2" style={{ color: "#25D366" }}></i>
          ...
          <Col lg={3} md={6} className="mb-4">
            <h5 className="text-uppercase text-white mb-4">Follow Us</h5>
            <div className="d-flex flex-wrap gap-3 social-links">
              <a href="https://whatsapp.com" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light btn-sm rounded-circle">
                <i className="bi bi-whatsapp" style={{ color: "#25D366" }}></i>
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light btn-sm rounded-circle">
                <i className="bi bi-twitter" style={{ color: "#25D366" }}></i>
              </a>
              <a href="mailto:info@example.com" className="btn btn-outline-light btn-sm rounded-circle">
                <i className="bi bi-envelope" style={{ color: "#25D366" }}></i>
              </a>
            </div>
          </Col>
        </Row>
