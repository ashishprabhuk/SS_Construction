    ...
    <footer className="bg-dark text-light footer-wrapper">
      <Container className="pt-5 pb-2">
        ...
        <Row className="g-4 mb-4">
          <Col lg={3} md={6} className="mb-3 d-flex justify-content-center align-items-center">
            <div className="iso-certification d-flex gap-3">
              <img src={iso1} alt="OA Certification" className="img-fluid certification-img" />
              <img src={iso2} alt="AGAC Certification" className="img-fluid certification-img" />
              <img src={iso3} alt="IAF Certification" className="img-fluid certification-img" />
            </div>
          </Col>
        </Row>
        ...
        <Row className="g-4">
          ...
          <Col lg={3} md={6} className="h-100">
            ...
            <div className="d-flex gap-2">
              ...
              <a href="https://www.instagram.com/ssultrareadymixconcrete/" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light btn-sm rounded-circle d-flex align-items-center justify-content-center">
                <i className="bi bi-instagram text-white"></i>
              </a>
              <a href="mailto:ssultrareadymix@gmail.com" className="btn btn-outline-light btn-sm rounded-circle d-flex align-items-center justify-content-center">
        ...
        <Row className="pt-4">
          <Col className="text-center">
            ...
            <p className="mb-0 py-2 text-secondary">
              ...
              Developed by{" "}
              <a href="https://www.andrometa.in" className="text-white text-decoration-none">
                <b>Andrometa</b>
              </a>
            </p>
          </Col>
